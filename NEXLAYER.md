...
**Live:** [https://relaxed-weasel-erxes.cloud.nexlayer.ai](https://relaxed-weasel-erxes.cloud.nexlayer.ai)  
...
**erxes** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/erxes/erxes:latest
    path: /
    servicePorts:
    - 3000
    vars:
      NODE_ENV: production
      MONGO_URL: "mongodb://mongo.pod:27017/erxes"
